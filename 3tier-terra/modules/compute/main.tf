...
resource "azurerm_virtual_machine_extension" "web-ext" {
  name                 = "iis-extension"
...
resource "azurerm_virtual_machine_extension" "app-ext" {
  name                 = "iis-extension"
...
#         command = "echo Learn bash programming from LinuxHint.com >> test.txt" 
#     }
# }